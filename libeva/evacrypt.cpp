...
static void teaEncipher( unsigned int* const v, const unsigned int* const k, unsigned int* const w )
{
...
static void teaDecipher( unsigned int* const v, const unsigned int* const k, unsigned int* const w )
{
    register unsigned int
        y     = ntohl(v[0]),
        z     = ntohl(v[1]),
...
void EvaCrypt::encrypt( unsigned char* instr, int instrlen, const unsigned char* key,
...
int EvaCrypt::decrypt( unsigned char* instr, int instrlen, const unsigned char* key,
            unsigned char*  outstr, int* outstrlen_ptr)
{
    unsigned char
        decrypted[8], m[8],
